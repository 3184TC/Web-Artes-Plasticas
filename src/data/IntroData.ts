...
const intro_data: DataType[] = [
   {
      ...
      icon: icon_1,
      title: "MISIÓN",
      desc: "Formar profesionales con excelencia en las Artes Plasticas, de recnocida capacidad, calidad y competitividad para ejercer las diferentes disciplinas artistica"
   },
   {
      id: 2,
      page:"home_1",
      icon: icon_2,
      title: "VISIÓN",
      desc: "La Carrera de Artes Plasticas por ser una carrera especializada dentro la Universidad Pública de El Alto, es reconocida por su excelencia y alta calidad académicar"
   },
   {
      id: 3,
      page:"home_1",
      icon: icon_3,
      title: "OBJETIVO",
      desc: "Formar profesionales idóneo de reconocida calidad human, creativa y especializada en Artes Plásticas, con capacidad teórica-práctica, con alto nivel de competitividad"
   },
